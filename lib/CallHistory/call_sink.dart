...
class CallActionWidget extends StatefulWidget {
  /// Construct the [CallActionWidget]
  const CallActionWidget({Key? key}) : super(key: key);

  @override
  _CallActionWidgetState createState() => _CallActionWidgetState();
}

class _CallActionWidgetState extends State<CallActionWidget> {
...
/// Class that add and update the log in [CallActionWidget]
class LogSink extends ChangeNotifier {
  final StringBuffer _stringBuffer = StringBuffer();

  /// Add log to [CallActionWidget]
  void log(String log) {
